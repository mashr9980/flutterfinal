...
import 'package:home_work_lutter_app/StudentAfterLogin.dart';
import 'package:intl/intl.dart';
import 'package:path/path.dart';
import 'package:ext_storage/ext_storage.dart';
import 'package:flutter_downloader/flutter_downloader.dart';

class AssignmnetStudentSide extends StatefulWidget {
  final String tid;
  final String sid;
  final String sName;

  AssignmnetStudentSide(
      {Key key, @required this.tid, @required this.sid, @required this.sName})
      : super(key: key);

  @override
  _AssignmnetStudentSideState createState() =>
      _AssignmnetStudentSideState(tid, sid, sName);
}

class _AssignmnetStudentSideState extends State<AssignmnetStudentSide> {
  final String tid;
  final String sid;
  final String sName;
  ...
  _AssignmnetStudentSideState(this.tid, this.sid, this.sName);
            ...
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.of(this.context).pushReplacement(MaterialPageRoute(
                    builder: (context) =>
                        StudentHome(uid: tid, name: sName, sid: sid)));
              },
            ),
  ...
  movetolastScreen() {
    Navigator.of(this.context).pushReplacement(MaterialPageRoute(
        builder: (context) => StudentHome(uid: tid, name: sName, sid: sid)));
  }
}
